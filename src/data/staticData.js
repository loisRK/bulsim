  ...
  transport: [
    {
      ...
      steps: [
        ...
        { step: '②', text: '송내역남부 정류장 → 버스 <b>14-1 · 47 · 16-1</b> 탑승' },
    ...
    },
    {
      icon: '🚗',
      label: '자가용',
      steps: [{ step: '📍', text: '인천광역시 남동구 무네미로312번길 30' }],
      info: '주차 가능 (사찰 앞 주차장)',
    },
  ],
}
...
export const QUICK_LINKS = [
  ...
  { icon: '📍', label: '오시는 길', sub: '찾아오는 방법',   href: '/about#location' },
]

export const SLIDES = [
  { img: '/photo/IMG_5231.jpeg', en: 'BULSHIMJEONGSA', title: '거마산 불심정사에\n오신 것을 환영합니다', desc: '부처님의 가르침이 살아 숨 쉬는 청정 도량' },
  { img: '/photo/IMG_5221.jpeg', en: 'MAIN HALL',      title: '대웅전 법회',                         desc: '연등이 가득한 법당에서 부처님의 자비를 만나세요' },
  { img: '/photo/IMG_5261.jpeg', en: 'DHARMA SERVICE', title: '정성스러운 법회',                     desc: '스님과 신도가 함께 기도하는 불심정사의 법회' },
  { img: '/photo/IMG_5290.jpeg', en: 'COMMUNITY',      title: '함께하는 불심정사',                   desc: '스님과 신도가 하나 되어 만들어가는 도량' },
]
...
export const NOTICES = [
  ...
  {
    id: 'volunteer', badge: '봉사', title: '자원봉사',
    items: [
...
export const NEWS = [
  { day: '24', month: '2025.05', title: '부처님오신날 법요식 봉행',    desc: '불기 2569년 부처님오신날을 맞아 성대한 법요식이 봉행되었습니다.' },
  { day: '18', month: '2025.05', title: '연등행렬 행사 안내',           desc: '부처님오신날을 앞두고 연등행렬이 진행됩니다. 많은 참여 바랍니다.' },
  { day: '10', month: '2025.05', title: '봄 정기 대청소 및 도량 정비', desc: '사부대중이 함께 도량을 정비하고 청정한 수행 환경을 만들었습니다.' },
  { day: '01', month: '2025.05', title: '초하루 법회 및 방생 행사',    desc: '5월 초하루 법회와 함께 생명 존중의 방생 행사가 진행되었습니다.' },
]

export const SCHEDULE = [
  { day: '매일',           time: '04:00 – 05:00', name: '새벽예불',           tag: 'tag-blue',  label: '매일' },
  { day: '매일',           time: '10:00 – 11:30', name: '사시불공',           tag: 'tag-blue',  label: '매일' },
  { day: '매일',           time: '17:00 – 17:30', name: '저녁예불',           tag: 'tag-blue',  label: '매일' },
  { day: '음력 매월 1일',  time: '10:00',          name: '초하루 신중기도',    tag: 'tag-green', label: '월간' },
  { day: '음력 매월 15일', time: '10:00',          name: '보름 미타 재일기도', tag: 'tag-green', label: '월간' },
  { day: '음력 매월 18일', time: '10:00',          name: '지장재일',           tag: 'tag-gold',  label: '재일' },
