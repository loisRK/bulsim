...
export default function About() {
  return (
    <>
      ...
      <section className="about-section" id="hall" style={{ background: '#fff', textAlign: 'center' }}>
        <div className="about-section-inner">
          <h2>대웅전</h2>
          <img src="/photo/IMG_5290.jpeg" alt="대웅전" style={{ width: '100%', maxWidth: 700, borderRadius: 6, marginBottom: 20 }} />
          <img src="/photo/IMG_5242.jpeg" alt="신도 법회" style={{ width: '100%', maxWidth: 700, borderRadius: 6 }} />
        </div>
      </section>
      ...
      <section className="about-section" id="location" style={{ background: '#fff' }}>
        <div className="about-section-inner">
          <h2>오시는 길</h2>
          <p style={{ fontSize: 14, color: 'var(--gray)', marginBottom: 24 }}>📍 {TEMPLE.address}</p>
